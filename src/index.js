...
function addDefaultProjectWork(name) {
    projectList.addProject(new Project(name, `This is where I put all my ${name.toLowerCase()} related tasks`));
...
function addDefaultProjectUni(name) {
    projectList.addProject(new Project(name, `This is where I put all my ${name.toLowerCase()} related tasks`));
...
function addDefaultProjectMisc(name) {
    projectList.addProject(new Project(name, `This is where I put all my ${name.toLowerCase()} related tasks`));
...
addDefaultProjectWork("Work");
addDefaultProjectUni("University");
addDefaultProjectMisc("Misc");

domManager.displayProjectList(projectList);
domManager.displayProject(projectList.projects[0]);
