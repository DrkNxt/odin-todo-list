...
function addDefaultProjectWork(projectList) {
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Simplify slide layouts", "low", new Date(), "These are optional notes", true));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Nullam et semper mi.", "very-low", new Date(), null, true));
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Vestibulum a iaculis nunc.", "normal", new Date(), "These are optional notes"));
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Aliquam mattis nulla tempus diam.", "very-high", new Date(), "These are optional notes", true));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("In hendrerit sed nulla eget.", "very-low", new Date(), null));
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("Maecenas porta consequat est sit.", "very-high", new Date(), "These are optional notes"));
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("Maecenas a enim quis est.", "normal", new Date(), null, true));
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("Suspendisse non interdum sapien.", "normal", new Date(), "These are optional notes"));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[3].addTodoItem(new TodoItem("Phasellus posuere tincidunt dui, at.", "normal", new Date(), null));
    projectList.projects[projectList.projects.length - 1].todoLists[3].addTodoItem(new TodoItem("Duis sit amet mollis diam.", "very-low", new Date(), "These are optional notes", true));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[4].addTodoItem(new TodoItem("Mauris et vulputate leo. Vestibulum.", "very-high", new Date(), "These are optional notes"));
...
function addDefaultProjectUni(projectList) {
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Etiam vel dignissim urna.", "very-high", new Date(), null));
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Vestibulum varius neque sed augue.", "high", new Date(), "These are optional notes"));
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Phasellus posuere tincidunt dui, at.", "normal", new Date(), null));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Phasellus eleifend quam lectus, eget.", "very-low", new Date(), "These are optional notes"));
}
...
function addDefaultProjectMisc(projectList) {
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Integer nec mi eu quam. Integer nec mi eu quam. Integer nec mi eu quam. Integer nec mi eu quam.", "high", new Date(), "These are optional notes These are optional notesThese are optional notes These are optional notes These are optional notes These are optional notes Integer nec mi eu quam. Integer nec mi eu quam.", true));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Praesent vitae orci nec tortor.", "very-high", new Date(), null));
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Pellentesque at felis venenatis, scelerisque.", "very-low", new Date(), "These are optional notes"));
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Etiam sed risus nec ex.", "high", new Date(), "These are optional notes", true));
}
