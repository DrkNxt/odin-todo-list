...
function addDefaultProjectWork(projectList) {
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Prepare introduction", "priority-4", null, null));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Vestibulum a iaculis nunc.", "priority-3", null, "These are optional notes"));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("Maecenas porta consequat est sit.", "priority-5", null, "These are optional notes"));
    projectList.projects[projectList.projects.length - 1].todoLists[2].addTodoItem(new TodoItem("Maecenas a enim quis est.", "priority-3", null, null, true));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[3].addTodoItem(new TodoItem("Phasellus posuere tincidunt dui, at.", "priority-3", null, null));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[4].addTodoItem(new TodoItem("Nullam ut elit id urna.", "priority-2", null, "These are optional notes"));
}
...
function addDefaultProjectMisc(projectList) {
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[0].addTodoItem(new TodoItem("Ut pellentesque magna tortor, sit.", "priority-2", null, "These are optional notes"));
    ...
    projectList.projects[projectList.projects.length - 1].todoLists[1].addTodoItem(new TodoItem("Praesent vitae orci nec tortor.", "priority-5", null, null));
